...
def get_args():
    ...
    parser.add_argument("--width", help='cap width', type=int, default=1200) #default=960
    parser.add_argument("--height", help='cap height', type=int, default=1000) #default=960
...
def main():
    ...
    while True:
        ...
        debug_image = np.zeros_like(image, dtype=np.uint8)
        debug_image[:, :] = [0, 255, 0]  # Green background
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
               ...
               # print(hand_sign_id)
                ...
                if hand_sign_id == 2:  # right gesture
                ...
                if hand_sign_id == 5:  # left gesture
                    # pyautogui.move(-100,0)
                    pyautogui.keyDown('U')
                    # Wait for some time (e.g., 2 seconds)
                    pyautogui.sleep(0.5) 
                ...
                if hand_sign_id == 4:  # fire gesture
